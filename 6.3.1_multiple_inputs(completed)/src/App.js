...
class App extends Component {
  ...
  formHandler = ({target}) =>{
     ...
     this.setState({
      [name] : type === "checkbox" ? {...this.state[name],[value] : !this.state[name][value]} :value
     });
    ...
    return (
      <div className="form">
        <div className="field-holder">
          <input type="text" placeholder="Name" name="name" onChange={this.formHandler} value={this.state.name} />
        </div>
        <div className="field-holder">
          <input
            type="email"
